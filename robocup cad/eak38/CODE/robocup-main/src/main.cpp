...
Task Tsensors_tof_read(80 * TASK_MILLISECOND, TASK_FOREVER, &sensors_tof_read);
Task Tsensors_tof_print(80* TASK_MILLISECOND, TASK_FOREVER, &sensors_tof_print);
Task Tmotors_PID_drive(5* TASK_MILLISECOND, TASK_FOREVER, &motors_PID_drive);
Task Tmotors_print(50* TASK_MILLISECOND, TASK_FOREVER, &motors_print);
Task Ttelem_read(20* TASK_MILLISECOND, TASK_FOREVER, &telem_read);
Task Tmotors_robot_servo_controller(100* TASK_MILLISECOND, TASK_FOREVER, &motors_robot_servo_controller);
Task Tsensors_ultrasonic_read(30* TASK_MILLISECOND, TASK_FOREVER, &sensors_ultrasonic_read);
Task Tsensors_navigation_print(50* TASK_MILLISECOND, TASK_FOREVER, &sensors_navigation_print);
Task Tnavigate_logic(30* TASK_MILLISECOND, TASK_FOREVER, &navigate_logic);
