...
extern bool inductiveState;
extern bool blueButtonState;
extern uint16_t ultraSonicFrontLeft;
extern uint16_t ultraSonicFrontRight;
extern uint16_t ultraSonicBackLeft;
extern uint16_t ultraSonicBackRight;
